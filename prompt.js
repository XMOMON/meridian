...
export function buildSystemPrompt(agentType, portfolio, positions, stateSummary = null, lessons = null, perfSummary = null, weightsSummary = null, decisionSummary = null, tradeProfile = null) {
...
${lessons ? `LESSONS LEARNED:\n${lessons}\n` : ""}${tradeProfile ? `\nTRADE INTELLIGENCE (statistical — use these patterns for decisions):\n${tradeProfile}\n` : ""}Timestamp: ${new Date().toISOString()}
`;
  }
